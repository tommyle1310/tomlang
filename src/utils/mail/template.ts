...
export const generateTemplateEmail = (options: IOptions) => {
	const { title, banner, btnTitle, link, logo, logoPlain, message, facebook, instagram, linkedIn, twitter } = options
	return `<!DOCTYPE html>
											...
											<tr>
												<td class="column column-1"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="width:100%;padding-right:0px;padding-left:0px; background: linear-gradient(#36454F, #023020);">
																<div align="center" class="alignment"
																	style="line-height:10px">
																	<div style="max-width: 160px;"><a
																			href="www.example.com" style="outline:none"
																			tabindex="-1" target="_blank"><img
																				alt="tomlang logo." height="auto"
																				src='${logo}'
																				style="display: block; height: auto; border: 0; width: 100%; "
																				title="tomlang logo." width="160" /></a>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div align="center" class="alignment"
																	...
																	<div style="max-width: 640px;"><a
																			...
																			tabindex="-1" target="_blank"><img
																				...
																				src='${banner}'
																				style="display: block; height: auto; border: 0; width: 80%;margin: 0 auto"
															...
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="word-break: break-word; color: #2b303a;"><strong>${title}</strong></span>
																	</p>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="word-break: break-word; color: #808389;">${message}</span>
																	</p>
																</div>
															</td>
														</tr>
...
<![endif]--><a href='${link}' style="background-color:#f7a50c;border-bottom:0px solid transparent;border-left:0px solid transparent;border-radius:35px;border-right:0px solid transparent;border-top:0px solid transparent;color:#ffffff;display:inline-block;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:undefined;mso-border-alt:none;padding-bottom:15px;padding-top:15px;text-align:center;text-decoration:none;width:auto;word-break:keep-all;"
																		target="_blank"><span
																			style="word-break: break-word; padding-left: 30px; padding-right: 30px; font-size: 16px; display: inline-block; letter-spacing: normal;"><span
																				style="margin: 0; word-break: break-word; line-height: 32px;"><strong>${btnTitle}</strong></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
																</div>
															</td>
														</tr>
													</table>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px">
																	<div class="fullWidth" style="max-width: 120px;"><a
																			href="www.example.com" style="outline:none"
																			tabindex="-1" target="_blank"><img
																				alt="tomlang logo " height="auto"
																				src="${logo}"
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0; word-break: break-word;"><span
																			style="word-break: break-word; color: #95979c;">tomlang
